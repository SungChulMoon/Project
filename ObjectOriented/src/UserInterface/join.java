...
public class join extends JFrame {
	...
	ImageIcon Icon_w0 = new ImageIcon("src/w_body0.png");
	ImageIcon Icon_w1 = new ImageIcon("src/w_body1.png");
	ImageIcon Icon_w2 = new ImageIcon("src/w_body2.png");
	ImageIcon Icon_w3 = new ImageIcon("src/w_body3.png");
	...
	ImageIcon Icon_m0 = new ImageIcon("src/m_body0.png");
	ImageIcon Icon_m1 = new ImageIcon("src/m_body1.png");
	ImageIcon Icon_m2 = new ImageIcon("src/m_body2.png");
	ImageIcon Icon_m3 = new ImageIcon("src/m_body3.png");
	...
	public join() {
		...
		JLabel label_4 = new JLabel("스  타   일");
		...
		btn_join.setBounds(120, 690, 440, 51);
		contentPane.add(btn_join);

		JButton btn_check = new JButton("중복검사");
