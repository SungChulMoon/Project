...
public class LineChartEx2 extends JPanel {
	...
	static HashMap<String, ArrayList<VO>> map = new HashMap<>();
	static ArrayList<ArrayList<VO>> todaymax = new ArrayList<>();
	...
	public static void getForcastWeather() {
		...
		try {
			...
			for (ArrayList<VO> temp : todaymax) {
				temp.clear();
			}
			...
			for (int i = 0; i < listarr.size(); i++) {
				...
				VO vo = new VO(inmain, temp, array[0], Double.valueOf(max), Double.valueOf(min));
